...
function Login() {
    ...
    const handleSubmit = (event) => {
        ...
        const url = values.userType === 'Admin' ? 'https://8080-feeacefcdebeabbcfdaafcbdaebccfbaabccd.project.examly.io/admin/login' : 'https://8080-feeacefcdebeabbcfdaafcbdaebccfbaabccd.project.examly.io/user/login';
